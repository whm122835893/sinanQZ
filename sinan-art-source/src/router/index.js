...
const routes = [
  ...
  { path: '/raffle', name: 'raffle', component: () => import('@/views/Raffle.vue'), meta: { title: '司南·抽签购' } },
  { path: '/raffle/:id', name: 'raffle-detail', component: () => import('@/views/RaffleDetail.vue'), meta: { title: '抽签详情' } },
